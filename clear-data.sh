...
#
# สิ่งที่ทำ:
#   1. TRUNCATE ตารางข้อมูล batch ทดสอบ (devices, batches, temp_alert_state, batch_events, pill_readings,
...
# temp_alert_state และ batch_events ต้องอยู่ในลิสต์ด้วย ไม่ใช่เพราะอยากล้าง แต่เพราะมี FK ชี้ไป batches
# ถ้าไม่ใส่ TRUNCATE จะ error "cannot truncate a table referenced in a foreign key constraint"
TABLES="control_log, phase_log, temp_controller_readings, pill_readings, temp_alert_state, batch_events, batches, devices"
COUNT_EXTRA=""
