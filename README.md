...
⚠️ คำสั่งนี้เป็น **IF ตัวที่ 16** ต่อท้ายสายใน Discord webhook ซึ่งทำให้ข้อเสนอเรื่องเปลี่ยนเป็น
Switch node คุ้มขึ้นอีก แต่ยังไม่ทำเพราะต้องเทสทุกคำสั่งผ่าน Discord จริงทีละอัน
